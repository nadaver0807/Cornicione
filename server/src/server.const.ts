...
export const EMAIL_FROM = process.env.EMAIL_FROM ?? 'Cornicione <onboarding@resend.dev>';

/** Inbox that receives leads and new orders. */
export const ADMIN_EMAIL = process.env.ADMIN_EMAIL ?? 'hello@cornicione.co.il';
...
/** פרטי המנהל היחיד של המערכת — התחברות באמצעות מייל וסיסמה. */
export const ADMIN_LOGIN_EMAIL = process.env.ADMIN_LOGIN_EMAIL ?? 'admin@cornicione.co.il';
export const ADMIN_PASSWORD = process.env.ADMIN_PASSWORD ?? 'cornicione';
